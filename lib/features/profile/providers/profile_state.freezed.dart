...
abstract class _$$ErrorImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, UserProfileModel? previousProfile});
}
...
class __$$ErrorImplCopyWithImpl<$Res>
  ...
  $Res call({
    Object? message = null,
    Object? previousProfile = freezed,
  }) {
    return _then(_$ErrorImpl(
      null == message
          ...
          : message // ignore: cast_nullable_to_non_nullable
              as String,
      previousProfile: freezed == previousProfile
          ? _value.previousProfile
          : previousProfile // ignore: cast_nullable_to_non_nullable
              as UserProfileModel?,
    ));
  }
}
...
class _$ErrorImpl implements _Error {
  const _$ErrorImpl(this.message, {this.previousProfile});
  ...
  @override
  String toString() {
    return 'ProfileState.error(message: $message, previousProfile: $previousProfile)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.previousProfile, previousProfile) ||
                other.previousProfile == previousProfile));
  }

  @override
  int get hashCode => Object.hash(runtimeType, message, previousProfile);
  ...
  TResult when<TResult extends Object?>({
    ...
    return error(message, previousProfile);
  }
...
abstract class _Error implements ProfileState {
  const factory _Error(final String message,
      {final UserProfileModel? previousProfile}) = _$ErrorImpl;

  String get message;
  UserProfileModel? get previousProfile;
